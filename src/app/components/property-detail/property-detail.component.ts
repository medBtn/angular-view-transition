import { Component, signal, computed, OnInit, Signal } from '@angular/core';
...
export class PropertyDetailComponent {
  // Mock data—replace with a real service
  ...
  route: Signal<ParamMap | null>;
  selectedProperty: Signal<Property | undefined>;

  constructor(private activatedRoute: ActivatedRoute) {
    this.route = toSignal(this.activatedRoute.paramMap, { initialValue: null });
    this.selectedProperty = computed(() => {
      const id = Number(this.route()?.get('id'));
